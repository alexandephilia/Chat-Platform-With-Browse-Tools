                            ...
                            <div className="p-1 bg-slate-100 rounded-t-[22px] sm:rounded-[22px] shadow-[inset_0_2px_4px_rgba(0,0,0,0.06)]">
                                ...
                                >
                                    ...
                                    <div className="px-5 sm:px-6 py-4 sm:py-5 flex items-center justify-between shrink-0">
                                        ...
                                        {/* Close button - raised soft style - hidden on mobile */}
                                        <button
                                            onClick={onClose}
                                            className="hidden sm:block p-2 rounded-xl text-slate-400 hover:text-slate-600 transition-all bg-slate-50/80 hover:bg-slate-100/80 shadow-[inset_0_1px_1px_rgba(255,255,255,1),0_1px_2px_rgba(0,0,0,0.04),0_0_0_1px_rgba(0,0,0,0.02)] active:shadow-[inset_0_2px_4px_rgba(0,0,0,0.08)] active:bg-slate-100"
                                        >
