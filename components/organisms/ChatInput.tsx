            ...
            >
                ...
                {variant === 'default' && (
                    <div className="px-3 py-1.5 border-b border-slate-100/50 flex items-center justify-between bg-white/50 backdrop-blur-[2px] rounded-t-[14px]">
                        ...
                        <span className="text-[10px] text-slate-400 font-medium">Work with Gemini 3.0 and Groq</span>
                    </div>
                )}
                    ...
                    <div className="flex items-center space-x-1 relative">
                        ...
                        <div className="relative" ref={menuContainerRef}>
                            ...
                            <button
                                ...
                                className={`
                                    p-1.5 rounded-xl transition-colors duration-200 group touch-manipulation
                                    ${isMenuOpen
