...
import { ProfilePortal } from '../molecules/ProfilePortal';
import { CustomInstructionsModal } from '../molecules/CustomInstructionsModal';
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div
                        onClick={!isAuthenticated ? openLoginModal : () => setIsProfileOpen(!isProfileOpen)}
